 ...
 * ## Formats
 *
 * For a full list, check out {@link module:@afforai/citation-js-plugin-ris.formats}.
 *
 * ## Configuration
 *
 * Check out {@link module:@afforai/citation-js-plugin-ris.config}.
 *
 * @module module:@afforai/citation-js-plugin-ris
 */
...
plugins.add('@ris', {
   ...
   * @memberof module:@afforai/citation-js-plugin-ris
   */
  input: {
    /**
     * RIS file.
   ...
   *
   * @deprecated Use the `spec` option of {@link module:@afforai/citation-js-plugin-ris.output.ris} instead.
   * @var {String} [outputSpec="mixed"]
   * @memberof module:@afforai/citation-js-plugin-ris.config
   */
